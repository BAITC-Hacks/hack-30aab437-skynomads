...
- 2026-09-23 — Пользователь запросил все пять опциональных функций и выбрал `main` с 3D-сценой. Активная ветка расширения: `feature/city-team-scenarios` от e771b18. Дополнительные события — явно синтетические условия; рейтинг сравнивает одинаковые условия. Базовая модель организаторов остаётся контрольной.
